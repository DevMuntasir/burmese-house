...
export const category = defineType({ name: "category", title: "Categories", type: "document", fields: [
...
export const product = defineType({ name: "product", title: "Products", type: "document", groups: [{ name: "content", title: "Content", default: true }, { name: "commerce", title: "Price & stock" }, { name: "marketing", title: "Marketing" }, { name: "search", title: "SEO" }], fields: [
...
], preview: { select: { title: "title", media: "images.0", price: "salePrice", regular: "regularPrice", stock: "stockQuantity", active: "active" }, prepare: ({ title, media, price, regular, stock, active }) => ({ title, subtitle: `${active ? "" : "HIDDEN · "}৳${price || regular} · ${stock ?? 0} in stock`, media }) } });

export const order = defineType({ name: "order", title: "Orders", type: "document", groups: [{ name: "overview", title: "Overview", default: true }, { name: "customer", title: "Customer" }, { name: "payment", title: "Payment" }, { name: "notes", title: "Notes" }], fields: [
